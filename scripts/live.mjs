...
if (!rawKey || !contract || !["baseline", "check", "adopt"].includes(stage)) {
  throw new Error("GENLAYER_PRIVATE_KEY, CONTRACT_ADDRESS, and LIVE_STAGE=baseline|check|adopt are required");
}
...
const source = "https://raw.githubusercontent.com/nearar22/drift-latch/main/fixtures/refund-policy.txt";
const watchId = "refund-policy";
const checkId = "deadline-cut";
